...
?>
<script src="../public/js/funciones_d.js"></script>
	...
	<nav class="navbar navbar-default " role="navigation">
		...
		<ul class="nav navbar-nav" style="padding-top: 10px;padding-bottom: 0px;">
			...
			if (isset($_SESSION['username']) && $_SESSION['rol'] == 'administrador') {
				echo '<button type="button" class="btn btn-primary  btn-sm"   onclick="cargar(\'#capa_d\',\'../models/Libro/alta_d.php\')">Alta</button>';
			}
			?>
