$(document).ready(function () {
  ...
  $("#btn_b_c").click(function (e) {
    ...
    $.ajax({
      type: "POST",
      url: "../models/Cartel/busqueda_c.php",
      data: "b=" + consulta,
      dataType: "html",
      beforeSend: function () {
        //imagen de carga
...
function preview(datos) {
  var shtml =
    ...
    $("#tit_Plantilla").val() +
    '">' +
    '<div style="background-image: url(images/cartelera/' +
    $("#t_file1").val() +
    ');">' +
    "<header>            <h1>" +
    $("#tit_titulo").val() +
  ...
  if (
    ...
    shtml =
      shtml +
      '<div id="cartel_imagen" class="row">' +
      '<div class="col-sm-4">' +
      $("#aut_texto1").val() +
      "</div>" +
      '<div class="col-sm-4"><img src="images/cartelera/' +
      $("#t_file").val() +
      '">' +
  ...
  if (
    ...
    shtml =
      ...
      "  " +
      "</div>" +
      '<div class="col-sm-10"><img src="images/cartelera/' +
      $("#t_file").val() +
      '">' +
      "</div>";
  }
  ...
  if (
    ...
    shtml =
      ...
      $("#aut_texto1").val() +
      "</div>" +
      '<div class="col-sm-6"><img src="images/cartelera/' +
      $("#t_file").val() +
      '">' +
      "</div>";
  }
