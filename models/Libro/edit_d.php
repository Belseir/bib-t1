				...
				<form role="form" method="POST" action="<?php echo $accion; ?>">
					...
					<div class="row">
						...
						<div class="form-group">
							<div class="col-xs-12">
								<label>Autor</label>
								<input type="text" size="20" name="txtAutor" class="form-control" placeholder="nombre del Autor" value="<?php echo $autor; ?>">
							</div>

							<div class="col-xs-12">
								<label>Titulo</label>
								<input type="text" size="20" name="txtTitulo" class="form-control" placeholder="Nombre de la publicacion" value="<?php echo $titulo; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-6">
								...
								<label>Idioma</label>
								<input type="text" size="10" name="txtOrigen" class="form-control" placeholder="Origen de la edición" value="<?php echo $origen; ?>">
							</div>

							<div class="col-xs-6">
								<label>Año de Publicación</label>
								<input type="text" size="10" name="txtAnio" class="form-control" placeholder="Año de la edición" value="<?php echo $anio; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-8">
								<label>Edicion</label>
								<input type="text" size="10" name="txtEdicion" class="form-control" placeholder="Detalles de la edición" value="<?php echo $edicion; ?>">
							</div>
						...
						<div class="form-group">
							<div class="col-xs-6">
								<label>Area</label>
								<input type="text" size="20" name="txtArea" class="form-control" placeholder="" value="<?php echo $area; ?>">
							</div>

							<div class="col-xs-6">
								<label>Materia</label>
								<input type="text" size="20" name="txtMateria" class="form-control" placeholder="" value="<?php echo $materia; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-12">
								...
								<input type="text" size="40" name="txtComentario" class="form-control" placeholder="" value="<?php echo $comentario; ?>">
							</div>
						</div>
