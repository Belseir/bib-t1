					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtNombre" class="form-control" id="ejemplo_nombre" placeholder="Introduce el nombre" />
							</div>
						</div>
						...
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtApellido" class="form-control" id="ejemplo_Apellido" placeholder="Introduce el Apellido" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtDni" class="form-control" id="ejemplo_Matricula" placeholder="Introduce el DNI" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtEmail" class="form-control" id="ejemplo_email" placeholder="correo electronico" />
							</div>
						</div>
						...
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtTelefono" class="form-control" id="ejemplo_telefono" placeholder="Telefono fijo o movil" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtUser" class="form-control" id="ejemplo_user" placeholder="Nombre de usuario" "/>
			 </div>
		   </div>	
	 <div class=" col-xs-4">
								<div class="form-group">
									<label for="ejemplo_pass">Password</label>
									<input type="password" size="20" name="txtPass" class="form-control" id="ejemplo_pass" placeholder="Cambiar Pass" />
								</div>
							</div>
							...
							<div class="col-xs-4">
								<div class="form-group">
									...
									<input type="password" size="20" name="txtPass1" class="form-control" id="ejemplo_pass1" placeholder="Cambiar Pass" />
								</div>
							</div>
