					...
					<div class="row">
						...
						<div class="col-xs-5">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtApellido" class="form-control" id="ejemplo_Apellido" placeholder="Introduce el Apellido" value="<?php echo $apellido; ?>" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtDni" class="form-control" id="ejemplo_dni" <input type="text" size="20" name="txtni" class="form-control" id="ejemplo_dni" placeholder="Introduce el DNI" value="<?php echo $dni; ?>" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtEmail" class="form-control" id="ejemplo_email" placeholder="correo electronico" value="<?php echo $email; ?>" />
							</div>
						</div>
						...
						<div class="col-xs-6">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtTelefono" class="form-control" id="ejemplo_telefono" placeholder="Telefono fijo o movil" value="<?php echo $telefono; ?>" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group">
								...
								<input type="text" size="20" name="txtUser" class="form-control" id="ejemplo_user" placeholder="Nombre de usuario" value="<?php echo $user; ?>" />
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
