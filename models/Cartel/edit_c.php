				...
				<form role="form" method="POST" action="<?php echo $accion; ?>">
					<div class="row">
						...
						<div class="form-group">
							...
							<div class="col-xs-12">
								<label>Titulo</label>
								<input type="text" size="20" name="txtTitulo" class="form-control" id="tit_titulo" placeholder="Encabezado/Titulo de la publicacion" value="<?php echo $titulo; ?>">
							</div>
					...
					<div class="form-group">
						<div class="col-xs-8">
							<label>Link</label>
							<input type="url" size="10" name="txtLink" class="form-control" id="tit_link" placeholder="Un enlace optativo" value="<?php echo $link; ?>">
						</div>
					...
					<div class="form-group">
						<div class="col-xs-6">
							<div class="ui-widget">
								...
								<input type="text" size="20" name="txtV_desde" class="form-control" id="tit_fechaD" placeholder="Fecha de inicio de la publicacion" value="<?php echo $v_desde; ?>">
							</div>
						</div>
						<div class="col-xs-6">
							<label>Fecha Hasta</label>
							<input type="text" size="20" name="txtV_hasta" class="form-control" id="tit_fechaH" placeholder="Fecha de finalizacion de la publicacion" value="<?php echo $v_hasta; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-xs-12">
							...
							<input onchange="preview();" type="text" size="2" name="txtPlantilla" class="form-control" id="tit_Plantilla" placeholder="Modelo de diseño" value="<?php echo $plantilla; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-xs-12">
							...
							<input id="t_file" type="text" name="txtImagen" class="form-control" value="<?php echo $imagen; ?>">
						</div>
						<div class="form-group">
							<div class="col-xs-12">
								<label>Imagen Encabezado</label>
								<input id="t_file1" type="text" name="txtImagen1" class="form-control" value="<?php echo $imagen1; ?>">
							</div>
